...
import { productByPopularity } from "../../admin/products/FetchApi";
...
const PageComponent = () => {
  ...
  const fetchData = async () => {
    try {
      let responseData = await productByPopularity(5);
...
const ProductByPopularity = (props) => {
  return (
    <Fragment>
...
export default ProductByPopularity;
